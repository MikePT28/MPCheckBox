...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  s.social_media_url   = "http://twitter.com/MikePT28"
  ...
  s.source       = { :git => "https://github.com/MikePT28/MPCheckBox.git", :commit => "f7a5baa590a140c33e5b8437d778b64b34d55b08" , :tag => "0.1" }
  ...
  s.source_files  = "MPCheckBox", "MPCheckBox/*.{h,m}"
